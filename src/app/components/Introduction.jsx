        ...
        <div className='grid grid-cols-1 sm:grid-cols-12'>
            <div className='col-span-7 place-self-center sm:text-left'>
                ...
                <div>
                    ...
                    <button className='px-1 py-1 w-full sm:w-fit rounded-full bg-gradient-to-br  from-green-200 via-green-500 to-green-800 hover:bg-slate-800 text-white mt-3'>
